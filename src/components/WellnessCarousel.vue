...
const cards: Card[] = [
  {
    ...
    desc: 'The number one predictor of dementia is loss of muscle mass. Increasing muscle mass improves not only your metabolism and aesthetic, but also your health span and quality of life. Through tailored nutrition and lifestyle coaching, along with a personalized regimen of peptides and supplements, we help you build and maintain the body you need to thrive.',
  },
  {
